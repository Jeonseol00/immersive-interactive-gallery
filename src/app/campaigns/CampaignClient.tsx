...
const campaignsData = [
  { date: "Agt 2026", title: "Neo-Classical Revival", desc: "Instalasi interaktif seni klasik di era digital. Mengeksplorasi ulang warisan sejarah dengan visual komputasi terkini.", img: "/images/bmt-zWE5.jpg" },
...
export function CampaignClient() {
  return (
    <div className="min-h-screen bg-transparent pt-24 md:pt-32 pb-20 px-6 md:px-12 relative z-10">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.p 
          ...
          className="text-neutral-400 text-lg mb-16 max-w-2xl"
        >
          Jelajahi pameran eksklusif dan inisiatif seni kolaboratif kami sepanjang tahun.
        </motion.p>
        
        <div className="flex flex-col gap-16 border-l border-white/10 pl-6 md:pl-10">
          {campaignsData.map((camp, i) => (
             <motion.div 
               key={i} 
             ...
             >
                ...
                <div className="relative aspect-[4/3] md:aspect-[16/9] w-full rounded-[1.5rem] overflow-hidden mb-6 border border-white/5 group-hover:border-white/20 transition-colors shadow-2xl">
